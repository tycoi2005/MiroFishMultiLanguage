    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              {{ $t('home.descBefore') }}<span class="highlight-bold">MiroFish</span>{{ $t('home.descAfterBrand') }}<span class="highlight-orange">{{ $t('home.agentScale') }}</span>{{ $t('home.descAfterScale') }}<span class="highlight-code">{{ $t('home.optimalSolution') }}</span>{{ $t('home.descAfterSolution') }}
            </p>
            <p class="slogan-text">
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              <div class="metric-value">{{ $t('home.metricCost') }}</div>
              <div class="metric-label">{{ $t('home.metricCostDesc') }}</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">{{ $t('home.metricScale') }}</div>
              <div class="metric-label">{{ $t('home.metricScaleDesc') }}</div>
            </div>
          </div>
          ...
          <div class="steps-container">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('home.steps.interaction') }}</div>
                  <div class="step-desc">{{ $t('home.steps.interactionDesc') }}</div>
                </div>
              </div>
            </div>
          </div>
