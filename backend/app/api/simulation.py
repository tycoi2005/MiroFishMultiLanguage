...
from .messages import msg, get_request_locale
...
def optimize_interview_prompt(prompt: str, locale: str = "en") -> str:
    """
    ...
    prefix = p.API_INTERVIEW_PROMPT_PREFIX
    if not prompt:
        return prompt
    # 避免重复添加前缀
    ...
    try:
        if not Config.ZEP_API_KEY:
            return jsonify(
                {
                    "success": False,
                    "error": msg("zep_not_configured", get_request_locale()),
                }
            ), 500
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg(
                        "entity_not_found", get_request_locale(), id=entity_uuid
                    ),
                }
            ), 404
    ...
    try:
        ...
        if not project_id:
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_project_id", get_request_locale()),
                }
            ), 400
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg(
                        "project_not_found", get_request_locale(), id=project_id
                    ),
                }
            ), 404
        ...
        if not graph_id:
            return jsonify(
                {
                    "success": False,
                    "error": msg("project_no_graph", get_request_locale()),
                }
            ), 400
    ...
    try:
        ...
        if not simulation_id:
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_simulation_id", get_request_locale()),
                }
            ), 400
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg(
                        "sim_not_found", get_request_locale(), id=simulation_id
                    ),
                }
            ), 404
                ...
                return jsonify(
                    {
                        ...
                        "data": {
                            ...
                            "status": "ready",
                            "message": msg("already_prepared", get_request_locale()),
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg(
                        "project_not_found", get_request_locale(), id=state.project_id
                    ),
                }
            ), 404
        ...
        if not simulation_requirement:
            return jsonify(
                {
                    "success": False,
                    "error": msg("missing_sim_requirement", get_request_locale()),
                }
            ), 400
        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    "task_id": task_id,
                    "status": "preparing",
                    "message": msg("graph_build_started", get_request_locale()),
    ...
    try:
        ...
        if not task_id:
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_task_or_sim_id", get_request_locale()),
                }
            ), 400
        ...
        if not task:
                    ...
                    return jsonify(
                        {
                            ...
                            "data": {
                                ...
                                "progress": 100,
                                "message": msg(
                                    "already_prepared", get_request_locale()
                                ),
                                "already_prepared": True,
                                "prepare_info": prepare_info,
                            },
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg("task_not_found", get_request_locale(), id=task_id),
                }
            ), 404
    ...
    try:
        ...
        if not config:
            return jsonify(
                {
                    "success": False,
                    "error": msg("config_not_found", get_request_locale()),
                }
            ), 404
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg(
                        "unknown_script", get_request_locale(), name=script_name
                    ),
                }
            ), 400
    ...
    try:
        ...
        if not graph_id:
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_graph_id", get_request_locale()),
                }
            ), 400
        ...
        if filtered.filtered_count == 0:
            return jsonify(
                {
                    "success": False,
                    "error": msg("no_matching_entities", get_request_locale()),
                }
            ), 400
            ...
            try:
                ...
                if max_rounds <= 0:
                    return jsonify(
                        {
                            "success": False,
                            "error": msg("max_rounds_positive", get_request_locale()),
                        }
                    ), 400
                ...
                return jsonify(
                    {
                        "success": False,
                        "error": msg("max_rounds_invalid", get_request_locale()),
                    }
                ), 400
            ...
            return jsonify(
                {
                    "success": False,
                    "error": msg(
                        "invalid_platform", get_request_locale(), type=platform
                    ),
                }
            ), 400
                            ...
                            return jsonify(
                                {
                                    "success": False,
                                    "error": msg(
                                        "sim_running_stop_first", get_request_locale()
                                    ),
                                }
                            ), 400
        ...
        if enable_graph_memory_update:
            ...
            if not graph_id:
                return jsonify(
                    {
                        "success": False,
                        "error": msg("graph_memory_needs_id", get_request_locale()),
                    }
                ), 400
            ...
            return jsonify(
                {
                    ...
                    "data": {
                        ...
                        "count": 0,
                        "posts": [],
                        "message": msg("db_not_exist", get_request_locale()),
                    },
                }
            )
    ...
    try:
        ...
        if agent_id is None:
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_agent_id", get_request_locale()),
                }
            ), 400

        if not prompt:
            return jsonify(
                {"success": False, "error": msg("provide_prompt", get_request_locale())}
            ), 400
        ...
        if platform and platform not in ("twitter", "reddit"):
            return jsonify(
                {
                    "success": False,
                    "error": msg("platform_invalid", get_request_locale()),
                }
            ), 400
        ...
        if not SimulationRunner.check_env_alive(simulation_id):
            return jsonify(
                {
                    "success": False,
                    "error": msg("sim_env_not_running", get_request_locale()),
                }
            ), 400
    ...
    try:
        ...
        if not interviews or not isinstance(interviews, list):
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_interviews", get_request_locale()),
                }
            ), 400
        ...
        for interview in interviews:
            ...
            optimized_interview["prompt"] = optimize_interview_prompt(
                interview.get("prompt", ""), locale=locale
            )
        ...
        return jsonify(
            {"success": False, "error": f"Batch interview timeout: {str(e)}"}
        ), 504
...
def interview_all_agents():
    ...
    try:
        ...
        return jsonify(
            {"success": False, "error": f"Global interview timeout: {str(e)}"}
        ), 504
...
def get_env_status():
    ...
    try:
        ...
        if env_alive:
            message = msg("env_running", get_request_locale())
        else:
            message = msg("sim_env_not_running", get_request_locale())
