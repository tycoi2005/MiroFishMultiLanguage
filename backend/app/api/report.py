    ...
    try:
                ...
                return jsonify(
                    {
                        ...
                        "data": {
                            ...
                            "status": "completed",
                            "message": msg("report_exists", get_request_locale()),
        ...
        if not graph_id:
            return jsonify(
                {
                    "success": False,
                    "error": msg("missing_graph_id", get_request_locale()),
                }
            ), 400
        ...
        if not simulation_requirement:
            return jsonify(
                {
                    "success": False,
                    "error": msg("missing_sim_desc", get_request_locale()),
                }
            ), 400
        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    "status": "generating",
                    "message": msg(
                        "report_started_check_progress", get_request_locale()
                    ),
                ...
                return jsonify(
                    {
                        ...
                        "data": {
                            ...
                            "status": "completed",
                            "progress": 100,
                            "message": msg("report_generated", get_request_locale()),
    ...
    try:
        ...
        if not report:
            return jsonify(
                {
                    "success": False,
                    "error": msg("report_not_found", get_request_locale()),
                }
            ), 404
    ...
    try:
        ...
        if not report:
            return jsonify(
                {
                    "success": False,
                    "error": msg("no_report_for_sim", get_request_locale()),
                    "has_report": False,
                }
            ), 404
...
def delete_report(report_id: str):
    ...
    try:
        ...
        return jsonify(
            {"success": True, "message": msg("report_deleted", get_request_locale())}
        )
    ...
    try:
        ...
        if not message:
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_message", get_request_locale()),
                }
            ), 400
    ...
    try:
        ...
        if not progress:
            return jsonify(
                {
                    "success": False,
                    "error": msg("report_progress_unavailable", get_request_locale()),
                }
            ), 404
            ...
            return jsonify(
                {
                    ...
                    "error": msg(
                        "section_not_found",
                        get_request_locale(),
                        id=f"section_{section_index:02d}.md",
                    ),
                }
            ), 404
    ...
    try:
        ...
        if not graph_id or not query:
            return jsonify(
                {
                    "success": False,
                    "error": msg("provide_graph_and_query", get_request_locale()),
                }
            ), 400
