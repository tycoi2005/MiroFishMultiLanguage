...
【模拟世界】
注入模拟世界的前提设定：{simulation_requirement}
...
【再次提醒】章节数量：最少3个，最多5个。每个章节都应在叙事弧线中承担明确的功能。"""
...
1. 首先思考这个章节需要什么素材
2. 然后调用工具从模拟世界中采集素材
3. 收集足够素材后输出 Final Answer（纯叙事文字，无任何标题）"""
