...
_original_ft_init_tw = _FunctionTool.__init__


def _patched_ft_init_tw(self, *args, **kwargs):
    _original_ft_init_tw(self, *args, **kwargs)
    try:
...
_FunctionTool.__init__ = _patched_ft_init_tw
